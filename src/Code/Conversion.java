...
// ----------------------------- UTILITY METHODS ------------------------------------ //
    ...
    // [OLD, USE THE Card's toString() METHOD] Prints the stats of a pokecardmaker.net/card Source
    public static void printMakerCardStats(String source) {
        String name = pullMakerStat(source, ":false,\"name\":");
        System.out.println("\n" + name + " HP: " + pullMakerStat(source, "hitpoints"));
        System.out.println(name + " ImageURL: https://dhcjt92fxib5i.cloudfront.net/" + pullMakerStat(source, "s3Key"));
        System.out.println(name + " CardNumber: " + pullMakerStat(source, "cardNumber"));
        System.out.println(name + " SetID: " + pullMakerStat(source, "totalInSet") + "\n");
    }
